...
from compare_cars.views import Get_allMakes,Get_allMakesDetails,Get_allModelDetails,Get_DataFromCity,Get_AllDataFromCity,elastic
...
urlpatterns = patterns(
    ...
    url(r'^api/(?P<text>[A-Za-z0-9\w @%.,_-]+)/$', elastic, name='api_searchlist'),
